...
RageUI.Settings = {
    ...
    Items = {
        Title = {
            Background = { Width = 431, Height = 87 },
            Text = { X = 218, Y = 3, Scale = 1.15 },
        },
        Subtitle = {
            Background = { Width = 431, Height = 30 },
            Text = { X = 8, Y = 4, Scale = 0.25 },
            PreText = { X = 425, Y = 4, Scale = 0.25 },
        },
        Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 0, Width = 431 },
        Navigation = {
            Rectangle = { Width = 431, Height = 25 },
            Offset = 5,
            Arrows = { Dictionary = "commonmenu", Texture = "shop_arrows_upanddown", X = 190, Y = -6, Width = 50, Height = 50 },
        },
        Description = {
            Bar = { Y = 0, Width = 0, Height = 0.5 },
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 20 },
            Text = { X = 8, Y = 6, Scale = 0.28 },
        },
    },
    Panels = {
        Grid = {
    ...
    if CurrentMenu ~= nil then
        if (CurrentMenu.Display.Header) then
            ...
            if (CurrentMenu.Display.Glare) then
                ...
                ---@type number
                local GlareX = CurrentMenu.X / 1920 + (CurrentMenu.SafeZoneSize.X / (64.599 - (CurrentMenu.WidthOffset * 0.065731)))
                ---@type number
                local GlareY = CurrentMenu.Y / 1080 + CurrentMenu.SafeZoneSize.Y / 40.595020746888
