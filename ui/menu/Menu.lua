...
function UIMenu:CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    self.Index = 1
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = TextureName or "interaction_bgd", Color = { R = R or 100, G = G or 150, B = B or 100, A = A or 150 } }
    self.Rectangle = nil
...
---@return UIMenu
---@public
RageUI.CreateMenu = function(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
function RageUI.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu then
        local Menu = UIMenu:CreateMenu(Title or ParentMenu.Title, string.upper(Subtitle) or string.upper(ParentMenu.Subtitle), X or ParentMenu.X, Y or ParentMenu.Y)
...
---@param Items fun(Items: _Items)
---@param Panels fun(Panels: _Panels)
