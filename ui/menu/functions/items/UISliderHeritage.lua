...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "mpleaderboard", Texture = "leaderboard_female_icon", X = 230, Y = 1, Width = 25, Height = 25 },
    RightArrow = { Dictionary = "mpleaderboard", Texture = "leaderboard_male_icon", X = 395, Y = 1, Width = 25, Height = 25 },
}
...
function _Items:UISliderHeritage(Label, ItemIndex, Description, Actions, Value)
