...
---@type table
local Colour = {
    Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 82 },
    LeftArrow = { Dictionary = "commonmenu", Texture = "arrowleft", X = 7.5, Y = 15, Width = 10, Height = 10 },
    RightArrow = { Dictionary = "commonmenu", Texture = "arrowright", X = 393.5, Y = 15, Width = 10, Height = 10 },
    Header = { X = 215.5, Y = 15, Scale = 0.05 },
    Box = { X = 15, Y = 55, Width = 74.5, Height = 24.5 },
    SelectedRectangle = { X = 15, Y = 47, Width = 74.5, Height = 8 },
    Seperator = { Text = "sur" }
}
...
---@return nil
---@public
function _Panels:ColourPanel(Title, Colours, MinimumIndex, CurrentIndex, Action, Index, Style)

    ---@type table
    local CurrentMenu = RageUI.CurrentMenu;

    if CurrentMenu ~= nil then
        if CurrentMenu and (not Index or CurrentMenu.Index == Index) then
